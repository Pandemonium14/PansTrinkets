...
import pansTrinkets.util.SingleViewWeightRender;
...
public class WeightSingleViewPatch {
    public static void Postfix(SingleCardViewPopup __instance, SpriteBatch sb) {
        AbstractCard c = (AbstractCard) ReflectionHacks.getPrivate(__instance, SingleCardViewPopup.class, "card");
        if(c instanceof AbstractTrinket) {
            SingleViewWeightRender.renderElementCost((AbstractTrinket) c, sb);
        }
    }
}